...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ margin: 0, padding: "2rem", fontFamily: "system-ui, sans-serif", backgroundColor: "#0a0a0a", color: "#fff", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ maxWidth: "600px", padding: "2rem", border: "1px solid #333", borderRadius: "8px", backgroundColor: "#1a1a1a" }}>
          ...
          <p style={{ color: "#999" }}>A critical error occurred.</p>
          {error?.message && (
